            ...
            <div className="col-md-4">
              <div className="item">
                <a href="#">
                  ...
                  <h5>Porównywarka cen materiałów budowlanych</h5>
                  <div className="line"></div>
                  <p>
                    Nie masz czasu zajmować się kompletowaniem zamówienia i
                    wyszukiwaniem najniższych cen na rynku materiałów
                    budowlanych, ale nie chcesz przepłacić? A może interesuje
                    Cię, czy Twoja oferta jest najlepsza? Nic prostszego! Napisz
                    do nas, a pomożemy Ci znaleźć najkorzystniejszą propozycję.
                    Wypełnij formularz kontaktowy i ciesz się zaoszczędzonym
                    czasem i pieniędzmi!
                  </p>
